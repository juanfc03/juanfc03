...
Ingeniero Informático especializado en la Ingeniería del Software, enfocado en el desarrollo Full-Stack, optimización de rendimiento e integración de sistemas basados en Inteligencia Artificial.

Me especializo en diseñar plataformas web sólidas y de arquitectura limpia. Disfruto trabajando en todo el ciclo del software: desde modelar la base de datos y asegurar el backend, hasta refinar interfaces accesibles y reactivas en el frontend. Mi enfoque técnico siempre busca un equilibrio entre la velocidad de entrega, la seguridad y la mantenibilidad del código a largo plazo.

* **Mi enfoque:** Desarrollo Full-Stack y flujos de trabajo con agentes de IA.
...
Además de la ingeniería de software, soy un auténtico entusiasta del hardware de PC y de la electrónica. Fuera del entorno digital, me apasiona la disciplina de entrenar e ir al gimnasio, un hábito que me ayuda a mantener la constancia, el enfoque y un estilo de vida activo.
